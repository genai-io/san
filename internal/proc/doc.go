...
// group and are not reached. On Windows the helpers terminate the child and
// its descendants, found by walking a process snapshot; a descendant whose
// parent already exited is not reached.
//
