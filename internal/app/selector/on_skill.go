...
func NewSkill(reg *coreskill.Registry) Skill {
	return Skill{
		registry:  reg,
		active:    false,
		skills:    []skillItem{},
...
func (s *Skill) EnterSelect(width, height int) error {
	if s.registry == nil {
...
func (s *Skill) tabCount(tab skillTab) int {
	count := 0
...
func (s *Skill) firstNonEmptyTab() skillTab {
...
func (s *Skill) saveLevelForActiveTab() bool {
...
func (s *Skill) cycleTab(delta int) {
...
func (s *Skill) CycleState() tea.Cmd {
...
func (s *Skill) HandleKeypress(key tea.KeyMsg) tea.Cmd {
	switch key.String() {
	case "tab", "right":
		s.cycleTab(+1)
		return nil
...
func (s *Skill) renderTabs() string {
	tabs := []kit.PanelTab{
...
func (s *Skill) renderEmpty() string {
	if len(s.skills) == 0 {
...
func (s *Skill) renderItemList(sb *strings.Builder, panel kit.Panel) {
...
func (s *Skill) renderHints() string {
	return kit.HintLine(
		"↑/↓ navigate",
		"Enter cycle state",
		"←/→/Tab switch tab",
