...
func TestProviderStatusExpiryIgnoresStaleTimer(t *testing.T) {
	...
	if cmd, handled := UpdateProvider(Runtime{}, state, ProviderStatusExpiredMsg{Token: first}); !handled || cmd != nil {
	...
	UpdateProvider(Runtime{}, state, ProviderStatusExpiredMsg{Token: second})
