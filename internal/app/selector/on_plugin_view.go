...
func (s *Plugin) boxWidth() int {
	return max(60, s.width-6)
}

func (s *Plugin) boxHeight() int {
	return max(18, s.height-4)
}

func (s *Plugin) contentWidth() int {
	return s.boxWidth() - 4 // padding(1,2) takes 4 chars
}

func (s *Plugin) bodyHeight() int {
	return max(6, s.boxHeight()-10)
}

func (s *Plugin) sepLine() string {
...
func (s *Plugin) renderFullWidth(content string) string {
...
func (s *Plugin) renderTabs() string {
...
func (s *Plugin) renderSearchBox(sb *strings.Builder) {
...
func (s *Plugin) renderTabList() string {
...
func (s *Plugin) getItemCount() (int, int) {
...
func (s *Plugin) getTabHint() string {
	switch s.activeTab {
	case pluginTabInstalled:
...
func (s *Plugin) renderInstalledList(sb *strings.Builder) {
...
func (s *Plugin) renderDiscoverList(sb *strings.Builder) {
	dimStyle := kit.DimStyle()
...
func (s *Plugin) renderMarketplacesList(sb *strings.Builder) {
	dimStyle := kit.DimStyle()
...
func (s *Plugin) renderInstalledDetail() string {
	if s.detailPlugin == nil {
		return s.renderTabList()
	}
...
func (s *Plugin) renderDiscoverDetail() string {
	if s.detailDiscover == nil {
		return s.renderTabList()
	}
...
func (s *Plugin) renderMarketplaceDetail() string {
	if s.detailMarketplace == nil {
		return s.renderTabList()
	}
...
func (s *Plugin) renderAddMarketplaceDialog() string {
	var sb strings.Builder
	cw := s.contentWidth()
...
func (s *Plugin) renderBrowsePlugins() string {
	var sb strings.Builder
	dimStyle := kit.DimStyle()
	brightStyle := lipgloss.NewStyle().Foreground(kit.CurrentTheme.TextBright)
...
func (s *Plugin) renderActions(sb *strings.Builder) {
	sb.WriteString("\n")
...
func (s *Plugin) renderFooter(sb *strings.Builder, hint string) {
	if s.isLoading {
...
func (s *Plugin) renderViewport(content string, scroll int) string {
