...
func (s *Provider) handleAPIKeyInput(key tea.KeyMsg) tea.Cmd {
	switch key.String() {
	case "enter":
...
func (s *Provider) handleCredentialEdit() tea.Cmd {
...
func (s *Provider) handleCredentialEditForProvider(item providerListItem) tea.Cmd {
...
func (s *Provider) handleCredentialEditForAuthMethod(item providerListItem) tea.Cmd {
...
func (s *Provider) handleCredentialRemove() tea.Cmd {
...
func (s *Provider) handleConfirmRemove(key tea.KeyMsg) tea.Cmd {
...
func (s *Provider) executeCredentialRemove() tea.Cmd {
...
func (s *Provider) tryConnectOrPromptKey(am providerAuthMethodItem, providerIdx, authIdx int) tea.Cmd {
...
func (s *Provider) initAPIKeyInput(envVar string) {
	ti := textinput.New()
