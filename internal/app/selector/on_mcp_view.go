...
func (s *MCP) renderErrorAndFooter(sb *strings.Builder, hint string) {
	if s.lastError != "" {
...
func (s *MCP) renderBox(content string) string {
...
func (s *MCP) renderDetail() string {
...
func (s *MCP) serverDetails(srv mcpServerItem) string {
	if srv.Status == coremcp.StatusConnected {
