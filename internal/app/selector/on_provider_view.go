...
func (s *Provider) contentWidth() int {
...
func (s *Provider) sepLine() string {
...
func (s *Provider) emptyFilterMsg() string {
...
func (s *Provider) renderItemList(sb *strings.Builder) {
...
func (s *Provider) renderTabs() string {
...
func (s *Provider) renderSearchBox() string {
...
func (s *Provider) renderEmptyState() string {
...
func (s *Provider) renderProviderHeader(item providerListItem) string {
...
func (s *Provider) renderModelRow(item providerListItem, isSelected bool) string {
	m := item.Model
...
func (s *Provider) renderProviderRow(item providerListItem, isSelected bool, itemIdx int) string {
	p := item.Provider
	if p == nil {
		return ""
	}
...
func (s *Provider) renderAuthMethod(item providerListItem, isSelected bool, itemIdx int) string {
	am := item.AuthMethod
	if am == nil {
		return ""
	}
...
func (s *Provider) renderAPIKeyInput() string {
...
func (s *Provider) renderConfirmRemove() string {
...
func (s *Provider) renderHints() string {
	if s.apiKeyActive {
...
func (s *Provider) appendConnectResult(envInfo string, itemIdx int) string {
...
func (s *Provider) connectResultStyle() lipgloss.Style {
...
func (s *Provider) renderConnectResult() string {
