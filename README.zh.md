...
| **Google** (Gemini) | `GOOGLE_API_KEY`，或 [Vertex AI](https://cloud.google.com/vertex-ai/generative-ai/docs/start/quickstarts/quickstart-multimodal)（`gcloud auth application-default login` + `GOOGLE_CLOUD_PROJECT`） |
